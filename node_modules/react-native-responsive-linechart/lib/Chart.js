...
var Chart = function (props) {
    ...
    var lineAndAreaComponents = childComponents.filter(function (c) { var _a, _b; return ['Line', 'Area'].includes((_b = (_a = c) === null || _a === void 0 ? void 0 : _a.type) === null || _b === void 0 ? void 0 : _b.name); });
    var otherComponents = childComponents.filter(function (c) { var _a, _b; return !['Line', 'Area'].includes((_b = (_a = c) === null || _a === void 0 ? void 0 : _a.type) === null || _b === void 0 ? void 0 : _b.name); });
                    ...
                    React.createElement(ChartContext_1.ChartContextProvider, { value: {
                        ...
                        React.createElement(react_native_svg_1.default, { width: dimensions.width, height: dimensions.height },
                            React.createElement(react_native_svg_1.G, { translateX: padding.left, translateY: padding.top },
                                ...
                                props.viewport && (React.createElement(react_native_1.View, { style: { marginLeft: padding.left, marginTop: padding.top } },
                                    React.createElement(react_native_svg_1.default, { width: dataDimensions.width, height: dataDimensions.height, viewBox: "0 0 " + dataDimensions.width + " " + dataDimensions.height }, lineAndAreaComponents)))))))))))));
};
exports.Chart = Chart;
